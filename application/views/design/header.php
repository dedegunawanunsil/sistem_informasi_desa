...
$user_groups = $this->session->user_groups;

$nama_lengkap = $user->first_name." ".$user->last_name;
$assets_file = FCPATH."assets/foto/";
if (file_exists($assets_file.$user->id.".jpg")) {
  $_SESSION['foto'] = base_url("assets/foto/".$user->id.".jpg");
} else if (file_exists($assets_file.$user->id.".png") ) {
  $_SESSION['foto'] = base_url("assets/foto/".$user->id.".png");
} else if (file_exists($assets_file."u.jpg") ) {
  $_SESSION['foto'] = base_url("assets/foto/u.jpg");
} else {
  $_SESSION['foto'] = base_url("assets/foto/u.png");
}
...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $nama_lengkap." - Dashboard";?></title>
  ...
  <body class="skin-black fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="<?php echo base_url();?>" class="logo"><?php echo $this->config->item('app_name');?></a>
            ...
            <ul class="nav navbar-nav">
              ...
              */
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo $this->session->foto;?>" class="user-image" alt="<?php echo $nama_lengkap;?>"/>
                  <span class="hidden-xs"><?php echo $nama_lengkap;?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="<?php echo $this->session->foto;?>" class="img-circle" alt="<?php echo $nama_lengkap;?>" />
                    <p>
                      <?php echo $nama_lengkap;?> - <?php echo $user_groups->description;?>
                      <small>Member since <?php echo date("j F Y", $user->created_on);?></small>
                    </p>
                  </li>
                  <?php 
                  /*
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="<?php echo base_url('manage/profil');?>">
            ...
            { ?>
            <li>
              <a href="<?php echo base_url('manage/list_all_user');?>">
