          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              echo form_input(array('name' => 'nikk',
                ...
                'class' => "form-control",
                'placeholder' => "NIKK",
                'value' => (@$this->form_validation->set_value('nikk') ? $this->form_validation->set_value('nikk') : $data->nikk),
              ));
              ?>
            </div> 	
		  </div>
          <div class="col-sm-6">
            <div class="form-group">
              ...
              echo form_dropdown('master_kampung', $master_kampung_arr,
               (@$this->form_validation->set_value('master_kampung') ? $this->form_validation->set_value('master_kampung') : $data->master_kampung_id), array('class' => 'form-control')
              );
              ?>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group">
              ...
              echo form_input(array('name' => 'alamat_detail',
                ...
                'value' => (@$this->form_validation->set_value('alamat_detail') ? $this->form_validation->set_value('alamat_detail') : $data->alamat_detail)
              ));
              ?>
            </div>
          </div>
