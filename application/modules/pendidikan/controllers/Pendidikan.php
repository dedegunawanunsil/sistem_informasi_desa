...
class pendidikan extends CI_Controller{
    ...
    public function index() {    
        ...
        $this->load->view('pendidikan/all', array(
            'data' => $this->pendidikan_model->get_all_pendidikan()
        ));
    ...
    function tambah() {
        ...
        {
            $insert = $this->pendidikan_model->insert(array(
                'nama' => $_POST['nama']
            ));
            if ($insert) {
    ...
    function detail($id) {
        ...
        if ($this->form_validation->run() == true)
        {
            //var_dump($_POST['id']);
            //exit();
            $insert = $this->pendidikan_model->update($_POST['id'], array(
                'nama' => $_POST['nama']
            ));
            if ($insert) {
        ...
        {
            $data = $this->pendidikan_model->get_pendidikan_by_id($id);
            $this->load->view('design/header');
