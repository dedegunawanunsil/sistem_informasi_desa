...
class pekerjaan extends CI_Controller{
    ...
    public function index() {    
        ...
        $this->load->view('pekerjaan/all', array(
            'data' => $this->pekerjaan_model->get_all_pekerjaan()
        ));
    ...
    function tambah() {
        ...
        {
            $insert = $this->pekerjaan_model->insert(array(
                'nama' => $_POST['nama']
            ));
            if ($insert) {
    ...
    function detail($id) {
        ...
        if ($this->form_validation->run() == true)
        {
            //var_dump($_POST['id']);
            //exit();
            $insert = $this->pekerjaan_model->update($_POST['id'], array(
                'nama' => $_POST['nama']
            ));
            if ($insert) {
        ...
        {
            $data = $this->pekerjaan_model->get_pekerjaan_by_id($id);
            $this->load->view('design/header');
